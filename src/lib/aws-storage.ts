...
const createS3Client = () => {
  ...
  if (!accessKeyId || !secretAccessKey) {
    console.error('Missing AWS credentials. Make sure AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY (or NEXT_PUBLIC_ versions) are set in your environment variables.');
...
const BUCKET_NAME = process.env.NEXT_PUBLIC_AWS_S3_BUCKET_NAME || process.env.AWS_S3_BUCKET_NAME || "";
